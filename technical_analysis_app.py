...
if start_date > end_date:
    st.sidebar.error('Error: The end date must fall after start date.')
...
sma_period = exp_sma.number_input(
    label='SMA Period',
    min_value=1,
    max_value=50,
    value=20,
...
st.write("""
        ...
        * you can add the following Technical Indicators to the plot: Simple Average, Bollinger Bands, Relative Strength Index
